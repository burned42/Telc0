...
gameOver.prototype = {
    create: function () {
        ...
        let totalScore = Math.floor(score * 4242 / (this.game.time.totalElapsedSeconds() - timeGameStartedAt));
        let scoreLabel = this.game.add.text(this.game.width / 2, this.game.height / 2 + 240, 'Score: ' + totalScore, {
           font: '32px Arial',
           fill: '#909296'
        });
